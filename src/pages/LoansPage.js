...
function generateReceiptHTML({ loan, borrower, installmentNum, amount, date }) {
  ...
  return `
    ...
    <body>
      ...
      <div class="footer">
        <p>Generated by <strong>Loan Moneyfest</strong> · Private workplace lending system</p>
...
function downloadReceiptPDF({ loan, borrower, installmentNum, amount }) {
  ...
  a.href = url
  a.download = `LoanMoneyfest_Receipt_${name}_Installment${installmentNum}_${dateStr}.html`
  a.click()
