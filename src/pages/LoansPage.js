...
function generateReceiptHTML({ loan, borrower, installmentNum, amount, date }) {
  ...
  return `
    ...
    <body>
      <div class="header">
        <div class="logo">Loan<span>Manifest</span></div>
      ...
      <div class="footer">
        <p>Generated by <strong>Loan Manifest</strong> · Private workplace lending system</p>
...
function downloadReceiptPDF({ loan, borrower, installmentNum, amount }) {
  ...
  a.href = url
  a.download = `LoanManifest_Receipt_${name}_Installment${installmentNum}_${dateStr}.html`
  a.click()
